...
export const metadata = createPageMetadata({
  ...
  description:
    'ROYO provides gypsum moulding and interior design services across Sri Lanka, with crafted ceiling works, wall finishes, pantry interiors, roofing, and metal welding.',
  path: '/',
})
